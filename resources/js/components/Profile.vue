                            ...
                            <div class="tab-pane active" id="settings">
                                <form class="form-horizontal">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" v-model="form.name" class="form-control" :class="{ 'is-invalid': form.errors.has('name') }" id="inputName"
                                                   placeholder="Name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" v-model="form.email" class="form-control"
                                                   :class="{ 'is-invalid': form.errors.has('email') }"      id="inputEmail"
                                                   placeholder="Email">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="password" class="col-sm-2 col-form-label">
                                            Password (live epty if no changing)</label>
                                        <div class="col-sm-10">
...
export default {
    ...
    methods: {
        getProfilePhoto(){
            let photo = (this.form.photo.length > 100) ? this.form.photo : "/storage/profile/" + this.form.photo
            return photo
        },
        updateProfile(e) {
            ...
            if (file['size']<2111775){
                ...
                swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'You are uploade large file'
                })
            }
        },
        updateInfo(){
